<%-- Created by IntelliJ IDEA. User: mukul Date: 09-05-2021 Time: 22:04 To change this template use File | Settings | File Templates. --%>
		...
		<div class="container-login100">
			<div class="wrap-login100">
					...
					<center>
						<div class="container">
							...
							<input type="text" id="voterid"
								placeholder="Enter Voter card number" name="voter_card_number"
								required> <input type="text" id="name"
								placeholder="Enter Fullname" name="name" required> <input
								type="text" id="username" placeholder="Enter Username"
								name="username" required> <select id="gender"
								name="gender" required>
								<option disabled="disabled" selected="selected">Select
									Gender</option>
								<option value="male">Male</option>
								<option value="female">Female</option>
							</select> <input type="date" id="dob" placeholder="Enter date of birth"
								name="dob" required> <input type="email" id="email"
				...
				<div class="login100-more"
					style="background-image: url('images/vote.png');"></div>
			</div>
